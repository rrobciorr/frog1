// Cursor
 		...
 		scene.fog = new THREE.Fog(0x00ffff, 10, 20);
		...
		*/
		...
		var zoff = 0;
		var inc = 0.05;
		var amplitude = 90 + (Math.random() * 70);
		var renderDistance = 1;
		var chunkSize = 10;
		var depth = 3; // keeps track of the depth of the world (in terms of blocks)
		...
		*/
		...
		var dirtTexture = [
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/dirt.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/dirt.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/dirt.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/dirt.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/dirt.png")}),
		...
		var cobblestoneTexture = [
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/cobblestone.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/cobblestone.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/cobblestone.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/cobblestone.png")}),
			new THREE.MeshBasicMaterial({map : loader.load("https://assets.codepen.io/3581324/cobblestone.png")}),
		...
		var blocks = [
			...
			{name : "cobblestone", materialArray : cobblestoneTexture, mesh : new THREE.InstancedMesh(blockBox, cobblestoneTexture, renderDistance * renderDistance * chunkSize * chunkSize * depth), count : 0, range : [3, 4]},
		];
		var blockTypes = ["grass", "dirt", "cobblestone"];
